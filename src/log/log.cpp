...
void et_log::logger_set_filepath(const std::string &file_path) {
	logger_->file_path_ = file_path;
}

void et_log::logger_set_logfile_name(const std::string &file_name) {
	logger_->file_name_ = file_name;
}

void et_log::logger_set_level(log_level_e log_level) {
	logger_->log_level_ = log_level;
}

void et_log::logger_set_filesize(size_t file_size) {
	logger_->max_logfilesize_ = file_size;
}

void et_log::logger_enable_fsync(bool flag) {
	if (flag) {
		logger_->enable_fsync_ = true;
	} else {
...
void et_log::logger_write(const char *buf, size_t size) {
...
void et_log::logger_print(log_level_e log_level, const char *fmt, ...) {
